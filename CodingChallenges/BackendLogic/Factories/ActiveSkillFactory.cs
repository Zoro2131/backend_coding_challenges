...
{
    public class MakeActiveSkill
    {
        //For Recruit Active Skill
        public ActiveSkill Grit()
        {
            CombatEffect bracedPosition = new()
            {
                //Active:
            ...
            ActiveSkill grit = new ActiveSkill
            {
                Name = "Grit",
                Cooldown = 30,
                IsUnlocked = true,

                CombatEffect = bracedPosition
            };
